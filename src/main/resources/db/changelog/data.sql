...
INSERT INTO topic (id, header, content, user_id) VALUES
(null, "user1 topic1", "user1 topic1 content", 1),
(null, "user1 topic2", "user1 topic2 content", 1),
(null, "user2 topic1", "user2 topic1 content", 2),
(null, "user3 topic1", "user3 topic1 content", 3),
(null, "admin1 topic1", "admin1 topic1 content", 4);
